...
@app.function
def plot_losses(epochs_seen, tokens_seen, train_losses, val_losses, data_root):
...
@app.cell
def _(data_root, num_epochs, tokens_seen, train_losses, val_losses):
    epochs_tensor = torch.linspace(0, num_epochs, len(train_losses))
    plot_losses(epochs_tensor, tokens_seen, train_losses, val_losses, data_root)
    return
